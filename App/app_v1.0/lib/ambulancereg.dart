...
class AmbulanceRegistrationPage extends StatefulWidget {
  @override
  _AmbulanceRegistrationPageState createState() => _AmbulanceRegistrationPageState();
}
                ...
                children: [
                  ...
                  Form(
                    child: Column(
                      ...
                      children: [
                        buildTextField('Name of the Driver', 'driverName',driverNameController),
                        buildTextField('Car Number', 'carNumber',carNumberController),
                        buildNumberField('Age', 'driverAge',
                            AgeController),
                        buildTextField('PAN Number', 'panNumber',panNumberController),
                        buildTextField('Driving License', 'license',DrivingLicenseController),
                        ...
                        Center(
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              await MongoDataBase.insertAmbulance(ambulanceData);
