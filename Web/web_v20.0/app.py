...
# Wait for 10 seconds
        ...
        if end - start >= 10:  # Check if 10 seconds have elapsed
    # Perform deletion from the database
            db.ambulance_pending.delete_one({'user_username': username})
            db.hospital_pending.delete_one({'user_username': username})
